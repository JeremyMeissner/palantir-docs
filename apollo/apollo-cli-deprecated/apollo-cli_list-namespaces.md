---
source_url: "https://www.palantir.com/docs/apollo/apollo-cli-deprecated/apollo-cli_list-namespaces/"
title: "Documentation | Apollo CLI [Deprecated] > apollo-cli list-namespaces [Deprecated]"
---
<!-- This file is auto-generated in the apollo-cli repo by ./godelw generate. Do not update manually! -->

# apollo-cli list-namespaces \[Deprecated]

:::callout{theme="warning"}
This command is [Deprecated](/docs/apollo/apollo-references/developer-api-limited-support-policies/).
This command is deprecated and will be removed in November 2025. Namespaces are a deprecated concept so this command will not be replaced.
:::

Lists all namespaces

```bash
apollo-cli list-namespaces [flags]
```
