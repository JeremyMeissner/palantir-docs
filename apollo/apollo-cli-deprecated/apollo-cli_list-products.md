---
source_url: "https://www.palantir.com/docs/apollo/apollo-cli-deprecated/apollo-cli_list-products/"
title: "Documentation | Apollo CLI [Deprecated] > apollo-cli list-products [Deprecated]"
---
<!-- This file is auto-generated in the apollo-cli repo by ./godelw generate. Do not update manually! -->

# apollo-cli list-products \[Deprecated]

:::callout{theme="warning"}
This command is [Deprecated](/docs/apollo/apollo-references/developer-api-limited-support-policies/).
This command is deprecated and will be removed in December 2025. Use [apollo-cli product list](/docs/apollo/apollo-cli/apollo-cli_product_list/) instead.
:::

Lists the product IDs for all products

```bash
apollo-cli list-products [flags]
```
