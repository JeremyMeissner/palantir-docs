---
source_url: "https://www.palantir.com/docs/apollo/apollo-cli-deprecated/apollo-cli_delete-environment/"
title: "Documentation | Apollo CLI [Deprecated] > apollo-cli delete-environment [Deprecated]"
---
<!-- This file is auto-generated in the apollo-cli repo by ./godelw generate. Do not update manually! -->

# apollo-cli delete-environment \[Deprecated]

:::callout{theme="warning"}
This command is [Deprecated](/docs/apollo/apollo-references/developer-api-limited-support-policies/).
This command is deprecated and will be removed in November 2025. Use [apollo-cli environment delete](/docs/apollo/apollo-cli/apollo-cli_environment_delete/) instead.
:::

Deletes an existing environment

```bash
apollo-cli delete-environment [flags]
```
