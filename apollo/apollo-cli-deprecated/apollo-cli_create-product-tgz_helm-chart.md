---
source_url: "https://www.palantir.com/docs/apollo/apollo-cli-deprecated/apollo-cli_create-product-tgz_helm-chart/"
title: "Documentation | Apollo CLI [Deprecated] > apollo-cli create-product-tgz helm-chart [Deprecated]"
---
<!-- This file is auto-generated in the apollo-cli repo by ./godelw generate. Do not update manually! -->

# apollo-cli create-product-tgz helm-chart \[Deprecated]

:::callout{theme="warning"}
This command is [Deprecated](/docs/apollo/apollo-references/developer-api-limited-support-policies/).
This command is deprecated and will be removed in December 2025.Use [apollo-cli product-release helm-chart init --as-tgz](/docs/apollo/apollo-cli/apollo-cli_product-release_helm-chart_init/) instead.
:::

Creates a helm-chart artifact

Creates a Helm Chart product manifest from the provided Helm Chart and then creates an Apollo
product TGZ with the extension ".config.tgz" in the specified output directory.

```bash
apollo-cli create-product-tgz helm-chart [flags]
```
...
* [apollo-cli create-product-tgz](/docs/apollo/apollo-cli-deprecated/apollo-cli_create-product-tgz/): Creates an artifact for Apollo
