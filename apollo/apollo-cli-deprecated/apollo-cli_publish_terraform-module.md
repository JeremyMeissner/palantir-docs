---
source_url: "https://www.palantir.com/docs/apollo/apollo-cli-deprecated/apollo-cli_publish_terraform-module/"
title: "Documentation | Apollo CLI [Deprecated] > apollo-cli publish terraform-module [Deprecated]"
---
<!-- This file is auto-generated in the apollo-cli repo by ./godelw generate. Do not update manually! -->

# apollo-cli publish terraform-module \[Deprecated]

:::callout{theme="warning"}
This command is [Deprecated](/docs/apollo/apollo-references/developer-api-limited-support-policies/).
This command is deprecated and will be removed in December 2025. Use [apollo-cli product-release terraform init](/docs/apollo/apollo-cli/apollo-cli_product-release_terraform_init/) to generate the manifest, and then use [apollo-cli product-release create](/docs/apollo/apollo-cli/apollo-cli_product-release_create/) to publish the product to Apollo.
:::

Publishes a terraform-module product to Apollo

```bash
apollo-cli publish terraform-module [flags]
```
...
| Flag                      | Use                      |
| ------------------------- | ------------------------ |
| `-h`, `--help` | Help for terraform-module |
