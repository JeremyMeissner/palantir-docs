---
source_url: "https://www.palantir.com/docs/apollo/apollo-cli-deprecated/apollo-cli_publish_manifest/"
title: "Documentation | Apollo CLI [Deprecated] > apollo-cli publish manifest [Deprecated]"
---
<!-- This file is auto-generated in the apollo-cli repo by ./godelw generate. Do not update manually! -->

# apollo-cli publish manifest \[Deprecated]

:::callout{theme="warning"}
This command is [Deprecated](/docs/apollo/apollo-references/developer-api-limited-support-policies/).
This command is deprecated and will be removed in December 2025. Use [apollo-cli product-release create --manifest <manifest>](/docs/apollo/apollo-cli/apollo-cli_product-release_create/) instead.
:::

Creates a new product release in Apollo from an Apollo product manifest file

```bash
apollo-cli publish manifest [flags]
```
