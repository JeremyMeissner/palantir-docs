---
source_url: "https://www.palantir.com/docs/apollo/apollo-cli/apollo-cli_changerequest_approve/"
title: "Documentation | Apollo CLI > apollo-cli changerequest approve"
---
<!-- This file is auto-generated in the apollo-cli repo by ./godelw generate. Do not update manually! -->

# apollo-cli changerequest approve

Approve a change request (asynchronously)

```bash
apollo-cli changerequest approve <request-rid> [flags]
```
...
| Flag                      | Use                      |
| ------------------------- | ------------------------ |
| `-c`, `--comment` | Optional comment for the approval |
