---
source_url: "https://www.palantir.com/docs/apollo/apollo-cli/apollo-cli_changerequest_reject/"
title: "Documentation | Apollo CLI > apollo-cli changerequest reject"
---
<!-- This file is auto-generated in the apollo-cli repo by ./godelw generate. Do not update manually! -->

# apollo-cli changerequest reject

Reject a change request

```bash
apollo-cli changerequest reject <request-rid> [flags]
```
...
| `-r`, `--reason` | Reason for rejecting the change request (required) |
