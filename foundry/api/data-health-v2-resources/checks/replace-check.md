---
source_url: "https://www.palantir.com/docs/foundry/api/data-health-v2-resources/checks/replace-check/"
title: "Replace Check \u2022 API Reference"
---
# Replace Check
...
| name | description |
| --- | --- |
| ModifyingCheckTypeNotSupported | Changing the type of a check after it has been created is not supported. |
...
| ReplaceCheckPermissionDenied | Could not replace the Check. |
