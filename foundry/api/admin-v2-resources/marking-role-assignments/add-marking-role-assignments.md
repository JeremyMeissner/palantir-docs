---
source_url: "https://www.palantir.com/docs/foundry/api/admin-v2-resources/marking-role-assignments/add-marking-role-assignments/"
title: "Add Marking Role Assignments \u2022 API Reference"
---
...
**operationId:** v2.addMarkingRoleAssignments

**path:** /api/v2/admin/markings/{markingId}/roleAssignments/add
...
**name:** AddMarkingRoleAssignmentsRequest
...
| AddMarkingRoleAssignmentsPermissionDenied | Could not add the MarkingRoleAssignment. |
