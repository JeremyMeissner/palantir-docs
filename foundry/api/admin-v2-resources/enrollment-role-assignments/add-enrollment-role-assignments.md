---
source_url: "https://www.palantir.com/docs/foundry/api/admin-v2-resources/enrollment-role-assignments/add-enrollment-role-assignments/"
title: "Add Enrollment Role Assignments \u2022 API Reference"
---
...
**operationId:** v2.addEnrollmentRoleAssignments

**path:** /api/v2/admin/enrollments/{enrollmentRid}/roleAssignments/add
...
**name:** AddEnrollmentRoleAssignmentsRequest
...
| AddEnrollmentRoleAssignmentsPermissionDenied | Could not add the EnrollmentRoleAssignment. |
