---
source_url: "https://www.palantir.com/docs/foundry/api/admin-v2-resources/users/get-user/"
...
| name | type | required | description |
| --- | --- | --- | --- |
| status | enumType | False | Present status of user. |
...
| UserIsActive | The user is an active user. |
