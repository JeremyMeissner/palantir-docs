---
source_url: "https://www.palantir.com/docs/foundry/api/connectivity-v2-resources/table-imports/create-table-import/"
title: "Create Table Import \u2022 API Reference"
---
# Create Table Import
...
**operationId:** v2.createTableImport
...
**example:** {"datasetRid":"ri.foundry.main.dataset.c26f11c8-cdb3-4f44-9f5d-9816ea1c82da","importMode":"SNAPSHOT","displayName":"My table import","allowSchemaChanges":true,"branchName":"master","config":{"type":"jdbcImportConfig","query":"SELECT * FROM table"}}
...
| CreateTableImportPermissionDenied | Could not create the TableImport. |
