---
source_url: "https://www.palantir.com/docs/foundry/api/connectivity-v2-resources/file-imports/replace-file-import/"
title: "Replace File Import \u2022 API Reference"
---
# Replace File Import
...
**operationId:** v2.replaceFileImport
...
**example:** {"importMode":"SNAPSHOT","displayName":"My file import","subfolder":"subfolder1/subfolder2","fileImportFilters":[{"type":"pathMatchesFilter","regex":"my-subfolder"}]}

### Response

#### Body

The replaced FileImport
...
| ReplaceFileImportPermissionDenied | Could not replace the FileImport. |
