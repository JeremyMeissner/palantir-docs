---
source_url: "https://www.palantir.com/docs/foundry/api/datasets-v2-resources/files/get-file-content/"
...
**operationId:** v2.getFileContent

**path:** /api/v2/datasets/{datasetRid}/files/{filePath}/content
...
| name | type | required | description |
| --- | --- | --- | --- |
| branchName | stringType | False | The name of the Branch that contains the File. Defaults to `master` for most enrollments. |
...
| FileSizeLimitExceeded | The requested file is larger than the configured maximum download size. Contact Palantir Support to discuss limit increases. |
...
| GetFileContentPermissionDenied | Could not content the File. |
