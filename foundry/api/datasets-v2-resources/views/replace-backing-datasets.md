---
source_url: "https://www.palantir.com/docs/foundry/api/datasets-v2-resources/views/replace-backing-datasets/"
title: "Replace Backing Datasets \u2022 API Reference"
---
...
[SNAPSHOT](/docs/foundry/data-integration/datasets#snapshot) transaction the next time the View is updated.

Third-party applications using this endpoint via OAuth2 must request the following operation scope: `api:datasets-write`.

**operationId:** v2.replaceBackingDatasets

**path:** /api/v2/datasets/views/{viewDatasetRid}/replaceBackingDatasets
...
**name:** ReplaceBackingDatasetsRequest
...
| ReplaceBackingDatasetsPermissionDenied | Could not replaceBackingDatasets the View. |
