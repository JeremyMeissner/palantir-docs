---
source_url: "https://www.palantir.com/docs/foundry/api/datasets-resources/files/delete-file/"
...
| --- | --- | --- | --- |
| datasetRid | stringType | True | The Resource Identifier (RID) of the Dataset on which to delete the File. |
| filePath | stringType | True | The File path within the Dataset. |

### Query Parameters

| name | type | required | description |
| --- | --- | --- | --- |
| branchId | stringType | False | The identifier (name) of the Branch on which to delete the File. Defaults to `master` for most enrollments. |
...
| PutSchemaPermissionDenied | todo |
