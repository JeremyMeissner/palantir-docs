---
source_url: "https://www.palantir.com/docs/foundry/api/ontologies-v2-resources/query-types/list-query-types/"
...
**operationId:** v2.listQueryTypesV2
...
| name | type | required | description |
| --- | --- | --- | --- |
| branch | stringType | False | The Foundry branch to list queries from. If not specified, the default branch will be used. Branches are an experimental feature and not all workflows are supported. |
