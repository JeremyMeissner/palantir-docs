---
source_url: "https://www.palantir.com/docs/foundry/api/general/overview/getting-started/"
...
Run the following to call the [apply action](/docs/foundry/api/v2/ontologies-v2-resources/actions/apply-action/) endpoint and trigger the `renameEmployee` action:

```bash
curl -X POST -H "Content-type: application/json" -H "Authorization: Bearer $FOUNDRY_TOKEN" \ # Store token securely or use OAuth2
 "https://<hostname>/api/v2/ontologies/company/actions/renameEmployee/apply" \
...
var url = "https://<hostname>/api/v1/ontologies/ri.ontology.main.ontology.efc12906-e7cd-49dc-b102-ff73e52535c8/objects/employee";
fetch(url, {
    headers: {
...
```javascript
var bearerToken = process.env.FOUNDRY_TOKEN; // Store token securely or use OAuth2; never send service user tokens to the browser
var url = "https://<hostname>/api/v1/ontologies/ri.ontology.main.ontology.efc12906-e7cd-49dc-b102-ff73e52535c8/actions/renameEmployee/apply";
...
String url = "https://<hostname>/api/v1/ontologies/ri.ontology.main.ontology.efc12906-e7cd-49dc-b102-ff73e52535c8/objects/employee";
...
```java
String bearerToken = System.getenv("FOUNDRY_TOKEN"); // Store token securely or use OAuth2
String url = "https://<hostname>/api/v1/ontologies/ri.ontology.main.ontology.efc12906-e7cd-49dc-b102-ff73e52535c8/actions/renameEmployee/apply";
