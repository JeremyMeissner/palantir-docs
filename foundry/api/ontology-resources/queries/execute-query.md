---
source_url: "https://www.palantir.com/docs/foundry/api/ontology-resources/queries/execute-query/"
...
**operationId:** v1.executeQuery

**path:** /api/v1/ontologies/{ontologyRid}/queries/{queryApiName}/execute
...
| --- | --- | --- | --- |
| ontologyRid | stringType | True | The unique Resource Identifier (RID) of the Ontology that contains the Query. To look up your Ontology RID, please use the **List ontologies** endpoint or check the **Ontology Manager**. |
