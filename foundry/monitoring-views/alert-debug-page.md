---
source_url: "https://www.palantir.com/docs/foundry/monitoring-views/alert-debug-page/"
title: "Documentation | Monitoring views > Alert debug page"
---
# Alert debug page
...
When a monitor rule has a Standard Operating Procedure (SOP) attached, the **Standard Operating Procedure (SOP)** card displays a link to the associated Notepad resource. The card provides quick access to troubleshooting steps and common resolutions documented for the rule.
