---
source_url: "https://www.palantir.com/docs/gotham/api/map-resources/maps/load-map/"
title: "Load a Map \u2022 API Reference"
---
# Load a Map
...
**operationId:** v1.loadMap

**path:** /api/gotham/v1/maps/load/{mapGid}
