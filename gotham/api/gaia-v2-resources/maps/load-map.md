---
source_url: "https://www.palantir.com/docs/gotham/api/gaia-v2-resources/maps/load-map/"
title: "Load Map \u2022 API Reference"
---
# Load Map
...
**operationId:** v2.loadMap

**path:** /api/v2/gaia/maps/{mapRid}/load
...
| LoadMapPermissionDenied | Could not load the Map. |
