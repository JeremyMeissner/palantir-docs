---
source_url: "https://www.palantir.com/docs/defense-osdk/api/missionPlanning/overview/"
title: "Mission Planning \u2022 API Reference"
---
...
## Mission Planning interfaces in the Defense OSDK

Designed to represent operational plans, associated tasks, entities, and their required resources, *Mission Planning's* [interfaces](/docs/foundry/interfaces/interface-overview) serve as the primary entity types in its ontology. [Interface link type constraints](/docs/foundry/interfaces/interface-link-types-overview) define the object-to-object relationship across object types that implement a Mission Planning interface.

[Learn more about how to develop with Mission Planning interfaces as your API layer](/docs/defense-osdk/api/missionPlanning/interfaceTypes/com-palantir-ontology-defense-types-operation).
